...
public class Main2 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 1; i<=114; i++) {
		extractCSVFrom(
				Constants.API_STEAMPOWERED_IDOTA2_MATCH_570 + Constants.GET_MATCH_HISTORY+"hero_id="+i+Constants.KEY,
				i);
		}
	}
	...
	private static void parseJSONtoCSV(List<Map<String, String>> flatJson, int to, String json) throws IOException {
		...
		CSVWriter.writeLargeFile(flatJson, ",", Constants.FILES_BY_HERO + "00-" +to + "/04-"+to+Constants.CSV, header);
